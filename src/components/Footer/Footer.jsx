                ...
                <div className={css.footer__row}>
                    ...
                    <div className={css.footer__col}>
                        ...
                        <div className={css.footer__rights}>
                            © 2024 | All Rights Reserved | Developed with by <span className={css.footer__rights__hearts}>❤</span> <span>FUTUMI<span className={css.footer__rights__small}>team</span></span>
                        </div>
                    ...
                    <div className={css.footer__col}>
                        <div className={css.footer__contact}>
                            <div className={css.footer__contact__title}>
                                Contact Us
                            </div>
